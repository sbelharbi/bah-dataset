...
from fer_models.apvit_backbones_basebackbone import BaseBackbone
from fer_models.apvit_backbones_modules_vit import Block
from fer_models.apvit_backbones_modules_vit_pooling import PoolingBlock
from fer_models.apvit_vit_layers import to_2tuple
from fer_models.apvit_vit_layers import trunc_normal_
from fer_models.apvit_vit_layers import resize_pos_embed_v2
from fer_models.apvit_backbones_modules_vit_pooling import top_pool
...
class PoolingViT(BaseBackbone):
    ...
    def init_weights(self, pretrained, patch_num=0):
        ...
        if patch_num != pos_embed.shape[1] - 1:
            print(f'interpolate pos_embed from {patch_pos_embed.shape[1]} '
                  f'to {patch_num}')
